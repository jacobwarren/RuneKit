...
extension RuneCLI {
    ...
    static func createMultiLineBoxFrame(contents: [String]) -> TerminalRenderer.Frame {
        ...
        let box = switch contents.count {
        case 0:
            Box(border: .single, flexDirection: .column, paddingRight: 1, paddingLeft: 1)
        case 1:
            Box(border: .single, flexDirection: .column, paddingRight: 1, paddingLeft: 1, children: Text(contents[0]))
        case 2:
            Box(
                border: .single,
                flexDirection: .column,
    ...
    static func createFinalResultsFrame(terminalWidth: Int, metrics: HybridPerformanceMetrics) -> TerminalRenderer
        .Frame
    {
    ...
    private static func createProgressBarTransform(value: Int, width: Int, label: String) -> Transform {
        Transform(transform: { template in
