...
struct ComponentTests {
    ...
    func testTextComponentTruncation() {
        // Arrange
    ...
    func testTextComponentZeroDimensions() {
        // Arrange
        let text = Text("Hello")
    ...
    func testTextComponentZeroWidth() {
        // Arrange
        let text = Text("Hello")
    ...
    func testTextComponentZeroHeight() {
        // Arrange
        let text = Text("Hello")
